...
ScoreBoard::ScoreBoard(const char *regularFont, const char *boldFont, int width, int height)
{
...
FancyScoreBoard::FancyScoreBoard(): ScoreBoard("fonts/Palanquin-Bold.ttf", "fonts/NotoSans-Bold.ttf", FULL_WIDTH, FULL_HEIGHT)
{
...
ProgrammerScoreBoard::ProgrammerScoreBoard(): ScoreBoard("fonts/NotoSansMono-Regular.ttf", "fonts/RobotoSlab-Bold.ttf", 1200, 110)
{
    update(std::make_shared<Referee>());
}
